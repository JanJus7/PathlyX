      ...
      <div className="bg-white p-10 rounded-3xl shadow-2xl max-w-md w-full text-center space-y-8">
        <div className="space-y-3">
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">
            Welcome to {" "}<a className="text-blue-400">PathlyX</a>!
          </h1>
          <p className="text-slate-500 font-medium">
            Log in to your accout to access the dashboard.
          </p>
        </div>
        ...
        <p className="text-xs text-slate-400 mt-4">
          Authorized personel only. By signing in, you agree to our{" "}
          <a href="#" className="text-slate-500 hover:text-slate-700 font-medium">
            Terms of Service
          </a>{" "}
          and{" "}
          <a href="#" className="text-slate-500 hover:text-slate-700 font-medium">
